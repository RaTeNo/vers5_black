...
<html lang="ru">
	<head>
		...
		<style>
			:root
			{	
			        --main_color1: rgba(255,255,255,0.05);
    				--main_color2: #C82481;
			}
			...
			<?php 
    			$main_color2 ="#C82481";
				$svg1 = '<svg width="57" height="14" viewBox="0 0 57 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M7 14C10.866 14 14 10.866 14 7C14 3.13401 10.866 0 7 0C3.13401 0 0 3.13401 0 7C0 10.866 3.13401 14 7 14Z" fill="'.$main_color2.'"/><path fill-rule="evenodd" clip-rule="evenodd" d="M32 12C34.7614 12 37 9.76142 37 7C37 4.23858 34.7614 2 32 2C29.2386 2 27 4.23858 27 7C27 9.76142 29.2386 12 32 12Z" fill="'.$main_color2.'"/><path fill-rule="evenodd" clip-rule="evenodd" d="M53.5 10.5C55.433 10.5 57 8.933 57 7C57 5.067 55.433 3.5 53.5 3.5C51.567 3.5 50 5.067 50 7C50 8.933 51.567 10.5 53.5 10.5Z" fill="'.$main_color2.'"/></svg>';

				$svg2 = '<svg width="1436" height="227" viewBox="0 0 1436 227" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity="0.346308" fill-rule="evenodd" clip-rule="evenodd" d="M713.339 226.999C417.57 227.324 121.084 87.1585 8.69902 27.7328C-4.74331 20.6249 0.415885 1.56702 15.6217 1.55033L1420.3 0.00887955C1435.55 -0.0078495 1440.72 19.1058 1427.22 26.1958C1313.61 85.8808 1013.83 226.67 713.339 226.999Z" fill="url(#paint0_linear)"/><defs><linearGradient id="paint0_linear" x1="1447.71" y1="226.235" x2="1447.47" y2="-0.775067" gradientUnits="userSpaceOnUse"><stop stop-color="'.$main_color2.'" stop-opacity="0.303813"/><stop offset="1" stop-color="'.$main_color2.'" stop-opacity="0.01"/></linearGradient></defs></svg>';
		...
		<div class="wrap">
			<div class="main">
				...
				<section class="first_section block">
					<div class="cont">
						<div class="info">
							<div class="title">Торговая сеть с <span>лучшими</span> товарами</div>
					...
					<div class="cont">
						...
						<div class="flex">
							...
							<div class="item">
								...
								<div class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti, odio?Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti, odio?</div>
							</div>
					...
					<div class="cont">
						...
						<div class="info">
							<div class="block_head">
								<div class="title">О нашей <span>Компании</span></div>
							</div>
						...
						<div class="slider owl-carousel">
							...
							<div class="slide">
								<a href="/" class="article">
									...
									<div class="info">
										<div class="name">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit, fugit.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit, fugit.</div>
				...
				<section class="reviews block">
					<div class="cont">
						...
						<div class="block_head">
							...
							<a href="/" class="all_link">Все отзывы
								<svg width="15" height="11" viewBox="0 0 15 11" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M9.34498 0C9.56236 0 9.77998 0.0821376 9.94564 0.24365L14.7509 4.91658C15.083 5.2396 15.083 5.76261 14.7509 6.08481L9.94564 10.7577C9.61347 11.0808 9.07565 11.0808 8.74433 10.7577L8.67132 10.6867C8.33915 10.3637 8.33915 9.8407 8.67132 9.5185L11.9533 6.32684H0.849544C0.380595 6.32684 0 5.95673 0 5.50069C0 5.04465 0.380595 4.67454 0.849544 4.67454H11.9533L8.67132 1.48288C8.33915 1.15985 8.33915 0.636847 8.67132 0.314648L8.74433 0.24365C8.91042 0.0821376 9.12761 0 9.34498 0Z" fill="white"/>
								</svg>
							</a>
							...
							<div class="slider owl-carousel">
								<div class="slide">
									<div class="review">
										...
										<div class="text">
											<p>
												Индекс «Пятёрочки» рассчитывается как соотношение стоимости продовольственного набора торговой сети «Пятёрочка» рассчитываемой Росстатом, и позволяет оценить ежемесячную динамику цен в сетевой розничной торговле. Индекс «Пятёрочки» рассчитывается как соотношение стоимости продовольственного набора торговой сети «Пятёрочка» рассчитываемой Росстатом, и позволяет оценить ежемесячную динамику цен в сетевой розничной торговле.Индекс «Пятёрочки» рассчитывается как соотношение стоимости продовольственного набора торговой сети «Пятёрочка» рассчитываемой Росстатом, и позволяет оценить ежемесячную динамику цен в сетевой розничной торговле.
											</p>
				...
				<section class="video_reviews block bg">
					<div class="cont">
				...
				<section class="documents block bg">
					<div class="cont">
				...
				<section class="services block">
					<div class="cont">
						...
						<div class="block_head">
							...
							<a href="/" class="all_link">Все услуги <svg width="15" height="11" viewBox="0 0 15 11" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M9.34498 0C9.56236 0 9.77998 0.0821376 9.94564 0.24365L14.7509 4.91658C15.083 5.2396 15.083 5.76261 14.7509 6.08481L9.94564 10.7577C9.61347 11.0808 9.07565 11.0808 8.74433 10.7577L8.67132 10.6867C8.33915 10.3637 8.33915 9.8407 8.67132 9.5185L11.9533 6.32684H0.849544C0.380595 6.32684 0 5.95673 0 5.50069C0 5.04465 0.380595 4.67454 0.849544 4.67454H11.9533L8.67132 1.48288C8.33915 1.15985 8.33915 0.636847 8.67132 0.314648L8.74433 0.24365C8.91042 0.0821376 9.12761 0 9.34498 0Z" fill="white"/>
											</svg></a>
						...
						<div class="flex">
							<a href="/" class="service">
								...
								<div class="info">
									...
									<div class="link">Подробнее <svg width="15" height="11" viewBox="0 0 15 11" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M9.34498 0C9.56236 0 9.77998 0.0821376 9.94564 0.24365L14.7509 4.91658C15.083 5.2396 15.083 5.76261 14.7509 6.08481L9.94564 10.7577C9.61347 11.0808 9.07565 11.0808 8.74433 10.7577L8.67132 10.6867C8.33915 10.3637 8.33915 9.8407 8.67132 9.5185L11.9533 6.32684H0.849544C0.380595 6.32684 0 5.95673 0 5.50069C0 5.04465 0.380595 4.67454 0.849544 4.67454H11.9533L8.67132 1.48288C8.33915 1.15985 8.33915 0.636847 8.67132 0.314648L8.74433 0.24365C8.91042 0.0821376 9.12761 0 9.34498 0Z" fill="white"/>
											</svg></div>
								</div>
							</a>
					...
					<form class="cont">
						...
						<div class="form">
							...
							<div class="bottom">
								...
								<div class="submit">
									<button type="submit" class="submit_btn">Отправить <svg width="15" height="11" viewBox="0 0 15 11" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M9.34498 0C9.56236 0 9.77998 0.0821376 9.94564 0.24365L14.7509 4.91658C15.083 5.2396 15.083 5.76261 14.7509 6.08481L9.94564 10.7577C9.61347 11.0808 9.07565 11.0808 8.74433 10.7577L8.67132 10.6867C8.33915 10.3637 8.33915 9.8407 8.67132 9.5185L11.9533 6.32684H0.849544C0.380595 6.32684 0 5.95673 0 5.50069C0 5.04465 0.380595 4.67454 0.849544 4.67454H11.9533L8.67132 1.48288C8.33915 1.15985 8.33915 0.636847 8.67132 0.314648L8.74433 0.24365C8.91042 0.0821376 9.12761 0 9.34498 0Z" fill="white"/>
											</svg></button>
								</div>
							</div>
				...
				<section class="stock_finish block bg">
					<div class="cont">
							...
							<form class="steps">
								<div class="step step1">
									...
									<div class="links">
										<button class="next" data-step=".step2">
											Начать <svg width="15" height="11" viewBox="0 0 15 11" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M9.34498 0C9.56236 0 9.77998 0.0821376 9.94564 0.24365L14.7509 4.91658C15.083 5.2396 15.083 5.76261 14.7509 6.08481L9.94564 10.7577C9.61347 11.0808 9.07565 11.0808 8.74433 10.7577L8.67132 10.6867C8.33915 10.3637 8.33915 9.8407 8.67132 9.5185L11.9533 6.32684H0.849544C0.380595 6.32684 0 5.95673 0 5.50069C0 5.04465 0.380595 4.67454 0.849544 4.67454H11.9533L8.67132 1.48288C8.33915 1.15985 8.33915 0.636847 8.67132 0.314648L8.74433 0.24365C8.91042 0.0821376 9.12761 0 9.34498 0Z" fill="white"/>
											</svg>
										</button>
									</div>
								...
								<div class="step step2">
									...
									<div class="links">
										...
										Продолжить <svg width="15" height="11" viewBox="0 0 15 11" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M9.34498 0C9.56236 0 9.77998 0.0821376 9.94564 0.24365L14.7509 4.91658C15.083 5.2396 15.083 5.76261 14.7509 6.08481L9.94564 10.7577C9.61347 11.0808 9.07565 11.0808 8.74433 10.7577L8.67132 10.6867C8.33915 10.3637 8.33915 9.8407 8.67132 9.5185L11.9533 6.32684H0.849544C0.380595 6.32684 0 5.95673 0 5.50069C0 5.04465 0.380595 4.67454 0.849544 4.67454H11.9533L8.67132 1.48288C8.33915 1.15985 8.33915 0.636847 8.67132 0.314648L8.74433 0.24365C8.91042 0.0821376 9.12761 0 9.34498 0Z" fill="white"/>
											</svg>
										</button>
